...
func (h *Handlers) render(rw http.ResponseWriter, r *http.Request, tmpl string, variables, data interface{}) error {
	return h.App.Render.Page(rw, r, tmpl, variables, data)
}
